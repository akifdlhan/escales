  ...
  <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <script>document.write(new Date().getFullYear())</script> &copy; Fi Slash Software <a href="https://figezgin.com/">Fi Gezgin</a> 
                            </div>
                            <div class="col-md-6">
                                <div class="text-md-end footer-links d-none d-sm-block">
                                    <a href="javascript:void(0);"> </a>
                                    <a href="javascript:void(0);">Yardım</a>
                                    <a href="javascript:void(0);">Destek Talebi Oluştur</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane active" id="settings-tab" role="tabpanel">
                        ...
                        <div class="p-3">
                            ...
                            <div class="d-grid mt-4">
                                <button class="btn btn-primary" id="resetBtn">Sıfırla</button>
                            </div>
